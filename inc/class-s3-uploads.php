...
#        $sdk = new DeliciousBrains\WP_Offload_Media\Aws3\Aws\Sdk($params);
...
#		avoid roundtrip to s3 for temp handling 		
                $new_path = tempnam(sys_get_temp_dir(), time() . basename( $file['tmp_name'] ));
